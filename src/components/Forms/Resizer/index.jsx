...
export default function Resizer() {
    ...
    const [alignment] = useState([faAlignLeft, faAlignCenter, faAlignRight, faAlignJustify]);
    ...
    return (
        <div className="col-12 p-1 animate__animated animate__fadeInRight" id="Resizer" onClick={(e) => { e.stopPropagation(); closeResizer() }}>
            <div className=" content d-flex flex-column gap-2 animate__animated animate__fadeInRight" onClick={(e) => { e.stopPropagation() }}>
                <button className="btn btn-warning" onClick={toggleBold}>B</button>
                <button className="btn btn-danger" onClick={decrementSize}>A-</button>
                <button className="btn btn-primary" onClick={incrementSize}>A+</button>
                ...
                <FontAwesomeIcon className="icon" onClick={changeAlign} icon={alignment[currentAlignment]} />
            </div>
        </div>
    )
}
