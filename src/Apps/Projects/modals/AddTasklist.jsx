...
export default function AddTasklist() {
  ...
  const { project_id } = useContext(ProjectsContext);
  ...
  const { closeModal } = useContext(ProjectsContext);

  return (
    <div className="Modal" id="addTasklistModal" onClick={closeModal}>
      <div
      ...
      >
        ...
        <datalist id="allTemplates"></datalist>
